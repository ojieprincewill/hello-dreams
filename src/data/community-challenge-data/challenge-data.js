export const CommunityChallengeData = [
  {
    id: 1,
    ...
    options: [
      {
        ...
        text2:
          "Deliverables: A clean and modern UI with a dashboard, task checklist, and progress summary.",
      ...
      },
      {
        ...
        text2:
          "Deliverables: A modern and user-friendly UI with a touch of your personal style. Share your final work on LinkedIn, Instagram, Twitter, or TikTok.",
        tag: "Share your final work on LinkedIn, Instagram, Twitter, or TikTok. Tag @Hello Dreams and use the hashtags #hellodreams #wedaretodream",
      },
      {
        id: 103,
        ...
        text2:
          "Deliverables: A responsive web UI showcasing the brand, app features, testimonials, and sign-up section.",
        tag: "Share your final work on LinkedIn, Instagram, Twitter, or TikTok. Tag @Hello Dreams and use the hashtags #hellodreams #wedaretodream",
      },
    ],
  },
    ...
    options: [
      {
        ...
        text2:
          "Deliverables: Short UX report or a carousel post with before/after suggestions.",
      ...
      },
      {
        ...
        title: "Create a User Flow for Booking a Doctor's Appointment Online",
        text1:
          "Challenge: Choose a Nigerian government or state website and perform a mini usability test. Identify 3 major usability issues and suggest improvements.",
        text2:
          "Deliverables: Short UX report or a carousel post with before/after suggestions.",
      ...
      },
      {
        ...
        text2:
          "Deliverables: Pain points identified, new flow suggestions, and sketches or wireframes.",
        tag: "Share your ideas on LinkedIn, Instagram, Twitter, or TikTok. Tag @Hello Dreams and use the hashtags #hellodreams #wedaretodream",
      },
    ],
  },
];
