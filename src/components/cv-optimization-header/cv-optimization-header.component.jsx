...
const CvOptimizationHeader = () => {
  ...
  return (
    <>
      <div className="relative bg-[#7f7def] w-full pt-3 md:pt-0 h-[640.67px] xl:h-[1019px] overflow-hidden">
        <NavBar />
        <motion.p
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5, ease: "easeOut" }}
          className="text-[#fff] text-[16px] md:text-[24.02px] mt-20 md:mt-10 xl:hidden text-center"
        ...
        <motion.img
          ...
          alt="purple clay"
          className="absolute bottom-[-15px] md:left-[60px] md:bottom-0 xl:bottom-[-90px] w-[483.18px] h-[332.73px] md:w-[646px] md:h-[444.84px] xl:w-[1291px] xl:h-[889px] object-cover "
        />
        <motion.img
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          ...
          alt="cv image"
          className="absolute left-[35px] bottom-[10px] md:left-[175px] md:bottom-[65px] xl:left-[225px] xl:bottom-[35px] w-[394.11px] h-[277.17px] md:w-[526.91px] md:h-[370.56px] xl:w-[1053px] xl:h-[740.55px] object-contain"
        />
      </div>
      <div className="grid grid-cols-1 md:grid-cols-[60%_40%] w-full h-full md:h-[463.33px] xl:h-[800px] md:place-items-center bg-[#eef2fe]">
        <motion.div
        ...
        >
          <p
            className="text-[#010413] text-[31.06px] md:text-[27.8px] xl:text-[48px] md:w-[306.96px] xl:w-[530px] mb-5 md:mb-7"
            style={{ fontFamily: "'DM Serif Display', serif" }}
          >
