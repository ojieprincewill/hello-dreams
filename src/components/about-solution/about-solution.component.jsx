  ...
  return (
    <div className="px-[5%] py-5 ">
      ...
      <div style={{ fontFamily: "'DM Sans', sans-serif" }}>
        <p className="text-[#667085] text-[10px] md:text-[13px] lg:text-[16px] leading-[2] lg:leading-[1.7] mb-7">
      ...
      <div className="w-full h-[193.34px] md:h-[350px] lg:h-[705px] rounded-2xl overflow-hidden mt-5">
        <img
          src="https://i.ibb.co/4RRVDYGD/dbe4f881fd1e5cfb795007237d9f1d1b3141a3ec.jpg"
          alt="happy tech man"
