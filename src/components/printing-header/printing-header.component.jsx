...
const PrintingHeader = () => {
  ...
  return (
    <div className=" bg-[#eef2fe] pt-3 md:pt-0">
      <NavBar />
      <div className="grid grid-cols-1 md:grid-cols-2 md:place-items-center w-full h-full md:h-[463.33px] lg:h-[800px]  ">
        <motion.div
        ...
        >
          ...
          <motion.div
            ...
            className="absolute top-[270px] md:top-[10px] left-[270px] lg:top-[-30px] lg:left-[484px] w-[30.7px] h-[30.7px] lg:w-[54px] lg:h-[54px] "
          >
            <img
