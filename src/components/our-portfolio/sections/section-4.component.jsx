...
const Section4 = () => {
  return (
    ...
    >
      <div className="relative bg-[#010413] p-5 w-full h-[451px] md:h-[450.29px] lg:h-[800px] rounded-2xl space-y-2 overflow-hidden">
        <p
        ...
        <p className="text-[17.95px] md:text-[15px] lg:text-[32px] text-[#f7f7f7] mb-3 font-semibold">
          Logo Design
        </p>
        <p
      ...
      <div className="relative bg-[#8b248a] p-5 w-full h-max md:h-[450.29px] lg:h-[800px] rounded-2xl space-y-2 overflow-hidden">
        <p
          className="text-[13.46px] md:text-[11.74px] lg:text-[24px] text-[#f7f7f7]"
          style={{ fontFamily: "'DM Sans', sans-serif" }}
        >
        ...
        <p className="text-[17.95px] md:text-[15px] lg:text-[32px] text-[#f7f7f7] mb-3 md:font-semibold">
          Branding & Graphics
        </p>
        <p
          className="text-[12px] md:text-[10px] lg:text-[18px] text-[#f7f7f7] mb-4"
