...
const Section5 = () => {
  return (
    ...
    >
      <div className="relative bg-[#499cb8] p-5 w-full h-[451px] xl:h-[800px] rounded-2xl space-y-2 overflow-hidden">
        <p
        ...
        <p
          className="text-[17.95px] md:text-[15px] xl:text-[32px] text-[#f7f7f7] mb-3 md:font-semibold"
        ...
        <div className="relative z-20">
          <a
            ...
            target="_blank"
          >
            <button className="bg-gradient-to-b from-[#f7f7f7] to-[#7ac4dd] min-w-[89.74px] md:min-w-[78.26px] xl:min-w-[160px] text-[#041856] text-[13.46px] md:text-[11.74px] xl:text-[16px] px-6 py-3 xl:py-4 font-bold text-center rounded-4xl cursor-pointer">
              View Details
            </button>
          </a>
        </div>
        ...
        <motion.div
          ...
          className="absolute z-10 bottom-[-50px] left-[-100px] xl:bottom-[-110px] xl:left-[-270px] w-[445px] h-[400px] xl:w-[991px] xl:h-[700px]"
        >
          <img
      ...
      <div className="relative bg-[#008080] p-5 w-full h-[451px] xl:h-[800px] rounded-2xl space-y-2 overflow-hidden">
        <p
          className="text-[13.46px] md:text-[11.74px] xl:text-[24px] text-[#f7f7f7]"
          style={{ fontFamily: "'DM Sans', sans-serif" }}
        >
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.7, ease: "easeOut", delay: 0.2 }}
          className="absolute z-10 bottom-[-30px] right-[-120px] xl:bottom-[-50px] xl:right-[-230px] w-[445px] h-[350px] xl:w-[891px] xl:h-[650px]"
        >
          <img
