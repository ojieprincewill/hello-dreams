  ...
  return (
    ...
    >
      <div className="relative bg-[#ff7f50] p-5 w-full h-[451px] md:h-[400.29px] xl:h-[800px] rounded-2xl space-y-2 overflow-hidden">
        ...
        <p className="text-[17.95px] md:text-[15px] xl:text-[32px] text-[#f7f7f7] mb-3 w-[170px] md:w-full md:font-semibold">
        ...
        <motion.div
          ...
          className="absolute z-10 bottom-[-80px] right-[-60px] xl:bottom-[-120px] xl:right-[-130px] w-[320px] h-[346px] xl:w-[640.92px] xl:h-[693px] rounded-3xl overflow-hidden"
        >
          <img
      ...
      <div className="relative bg-[#0b83d9] p-5 w-full h-[451px] md:h-[400.29px] xl:h-[800px] rounded-2xl space-y-2 overflow-hidden">
        <p
          className="text-[13.46px] md:text-[11.74px] xl:text-[24px] text-[#f7f7f7]"
          style={{ fontFamily: "'DM Sans', sans-serif" }}
        >
        ...
        <p className="text-[17.95px] md:text-[15px] xl:text-[32px] text-[#f7f7f7] w-[207px] xl:w-[307px] mb-3 md:font-semibold">
        ...
        <div className="relative z-20">
          <a href="https://www.sisenow.co.uk" target="_blank">
            <button className="bg-gradient-to-b from-[#f7f7f7] to-[#90c0e26b] min-w-[89.74px] md:min-w-[78.26px] xl:min-w-[160px] text-[#041856] text-[13.46px] md:text-[11.74px] xl:text-[16px] px-6 py-3 xl:py-4 font-bold text-center rounded-4xl cursor-pointer ">
              View
            </button>
          </a>
        </div>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.7, ease: "easeOut", delay: 0.2 }}
          className="absolute z-10 bottom-[-10px] right-[-70px] xl:bottom-[-20px] xl:right-[-50px] w-[334.31px] h-[311.41px] xl:w-[448.31px] xl:h-[622.41px]"
        >
          <img
