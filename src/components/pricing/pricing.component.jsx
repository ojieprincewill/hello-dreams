...
const Pricing = () => {
  ...
  return (
    <div className="w-full h-max md:h-[542.68px] xl:h-[937px] bg-gradient-to-b from-[#010413] to-[#ffffff] px-[3%] md:px-0 py-5 md:py-15 xl:py-30 my-10">
      <p
        className="text-[24px] md:text-[27.8px] xl:text-[48px] text-[#f7f7f7] text-center font-bold mb-2 md:mb-4"
        style={{ fontFamily: "'DM Sans', sans-serif" }}
      >
        Pricing
      </p>
      <p
        className="text-[12px] md:text-[16.22px] xl:text-[28px] text-[#f7f7f7] font-medium xl:font-medium text-center mb-5 xl:mb-7"
        style={{ fontFamily: "'DM Sans', sans-serif" }}
      >
        ...
        >
          {CvPricingData.slice(0, 2).map((data, index) => (
            ...
            >
              ...
              >
                <button className="w-full bg-[#010413] text-[#f7f7f7] font-semibold border border-[#010413] mt-5 text-[8.91px] xl:text-[15px] px-6 py-2 xl:py-3 rounded-lg hover:text-white hover:bg-[#1342ff] hover:border-[#1342ff] transition-colors duration-300 cursor-pointer">
          ...
          {CvPricingData.slice(2).map((data) => (
            ...
            >
              ...
              <Link to="/services/optimize-profile" onClick={handleOrigins}>
                <button className="bg-[#efece9] w-full text-[#101828] font-bold border border-[#efece9] text-[8.91px] xl:text-[15px] px-6 py-2 xl:py-3 rounded-lg hover:text-white hover:bg-[#101828] hover:border-[#101828] transition-colors duration-300 cursor-pointer">
                  Get a Free Consultation
                </button>
              </Link>
            </motion.div>
