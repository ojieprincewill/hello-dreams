  ...
  return (
    ...
    >
      ...
      <div className="mt-5 md:mt-10 w-full md:w-[280.23px] ">
        <button className="bg-black w-full text-[14px] md:text-[16px] text-white px-6 py-2 rounded-md font-medium hover:bg-[#1342ff] transition-colors duration-300 cursor-pointer mb-2">
          Sign up
        </button>
        ...
        <button className="bg-transparent w-full text-[14px] md:text-[16px] border border-[#e5e7eb] text-[#101828] px-6 py-2 rounded-md font-medium hover:bg-[#eef2fe] transition-colors duration-300 cursor-pointer mt-2">
          Sign in
        </button>
      </div>
    </div>
