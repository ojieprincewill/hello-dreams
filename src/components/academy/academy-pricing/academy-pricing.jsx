...
const AcademyPricing = () => {
  ...
  return (
    <div className="w-full px-[5%] xl:px-[14%] py-10">
      <div>
        <h1
          className="text-[#101828] text-[20px] md:text-[30px] xl:text-[48px] font-bold text-center mb-4"
        ...
        <div
          className="text-[#667085] text-[14px] md:text-[16px] xl:text-[18px] md:text-center font-medium mb-10"
          style={{ fontFamily: "DM Sans, sans-serif" }}
        >
          <p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-10 md:my-15">
          ...
          <div className=" bg-white rounded-2xl shadow-2xl p-4 md:p-6 xl:p-8 flex flex-col justify-between">
            <div>
              <span className="inline-block bg-[#ff7f50] text-[#fff] text-[10px] tracking-[1px] font-extrabold rounded-full px-4 py-2 mb-8">
                One time payment
              </span>
              <h2 className="text-[#101828] text-[20px] md:text-[28px] xl:text-[36px] font-bold mb-1">
                Buy a course
              </h2>
          ...
          {/* Subscription card */}
          <div className="bg-[#1342ff] rounded-2xl shadow-2xl p-4 md:p-6 xl:p-8 flex flex-col justify-between">
            <div>
              <span className="inline-block bg-[#ff7f50] text-[#fff] text-[10px] tracking-[1px] font-extrabold rounded-full px-4 py-2 mb-8">
                Recommended
              </span>
              <h2 className="flex items-center text-white text-[20px] md:text-[28px] xl:text-[36px] font-bold mb-1">
                ₦12,000{" "}
