...
import { PreviewData3 } from "../../../data/academy-data/academy.data";
...
const Preview3 = () => {
  return (
    <>
      ...
      >
        <p className="text-[#010413] text-[40px] font-bold">20 Mins Classes</p>
