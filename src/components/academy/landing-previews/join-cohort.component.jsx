  ...
  return (
    <>
      ...
      <div className="w-full bg-[#eef2fe] rounded-2xl overflow-hidden px-[5%] py-5 mb-15 ">
        ...
        <div
          className="bg-[#010413] w-full h-[38px] md:h-[58px] lg:h-[98px] flex justify-center items-center space-x-2 rounded-xl overflow-hidden my-5 "
          style={{ fontFamily: "'DM Sans', sans-serif" }}
        >
          <span className="text-[#f7f7f7] text-[10px] md:text-[14px] lg:text-[18px] font-medium px-2 md:px-5 py-2 bg-transparent rounded-md hover:bg-[#ff7f50] transition-colors duration-300 cursor-pointer ">
            Course details
          </span>
          <span className="text-[#f7f7f7] text-[10px] md:text-[14px] lg:text-[18px] font-medium px-2 md:px-5 py-2 bg-transparent rounded-md hover:bg-[#ff7f50] transition-colors duration-300 cursor-pointer ">
            Requirements
