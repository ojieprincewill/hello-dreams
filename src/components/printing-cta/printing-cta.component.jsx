      ...
      <div className="flex flex-col-reverse justify-center items-center md:grid md:grid-cols-2 md:gap-8">
        ...
        <div className="flex flex-col justify-center items-center mb-6 md:mb-0">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-[#009379] w-[64px] h-[64px] md:w-[71.82px] md:h-[71.82px] lg:w-[124px] lg:h-[124px] mb-10 rounded-tr-[40%] rounded-bl-[40%] md:rounded-tr-[40%] md:rounded-bl-[40%] overflow-hidden"
          ></motion.div>
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
