...
const BrandingPackage = () => {
  ...
  return (
    <div className="w-full h-max md:h-[542.68px] lg:h-[937px] bg-gradient-to-b from-[#010413] to-[#ffffff] px-[3%] md:px-0 py-5 md:py-15 lg:py-20 my-10">
      <p
        className="text-[24px] md:text-[27.8px] lg:text-[64px] text-[#f7f7f7] text-center mb-2 md:mb-4"
        style={{ fontFamily: "'Radio Canada', sans-serif" }}
      >
        Branding Package for <span className="font-bold">SME</span>
      </p>
      <p
        className="text-[12px] md:text-[16.22px] lg:text-[28px] text-[#f7f7f7] font-medium lg:font-medium text-center lg:w-[893px] lg:mx-auto mb-5 lg:mb-7"
