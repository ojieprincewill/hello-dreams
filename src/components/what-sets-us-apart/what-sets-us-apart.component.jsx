...
const WhatSetsUsApart = () => {
  return (
    <div className="w-full px-[5%] lg:px-[10%] py-10 md:py-20">
      ...
      <p
        className="text-[12px] lg:text-[17.44px] text-[#667085] text-center font-bold mb-15"
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-7">
        {SetApartData.map((data) => (
          <div key={data.id} className="p-3 border border-[#ccc] rounded-2xl">
            ...
            <div>
              <button className="w-full bg-[#1342ff] lg:bg-[#010413] text-[#f7f7f7] lg:hidden font-semibold border border-[#1342ff] lg:border-[#010413] text-[10.91px] lg:text-[16px] px-6 py-2 lg:py-4 rounded-lg lg:rounded-lg hover:text-white hover:bg-[#1342ff] hover:border-[#1342ff] transition-colors duration-300 cursor-pointer">
                Learn more
              </button>
            </div>
          </div>
