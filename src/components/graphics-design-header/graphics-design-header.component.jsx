  ...
  return (
    <div className="relative bg-[#ffc501] py-3 md:pl-15 lg:pl-30 md:py-15 h-[755px] md:h-[663.07px] lg:h-[1024px] overflow-hidden">
      ...
      <motion.p
        ...
        whileInView={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.7, ease: "easeOut" }}
        className="text-[#101828] text-[14px] lg:text-[24px] w-[90%] mx-auto md:mx-0 md:w-[357px] lg:w-[606px] text-center md:text-left leading-[1.2] mb-3 md:mb-6 "
      >
      ...
      <motion.div
        ...
        whileInView={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.7, ease: "easeOut" }}
        className="flex justify-center items-center mt-[60px] mx-auto md:mt-0 md:mx-0 md:absolute md:bottom-[-78px] md:right-[-90px] lg:bottom-[-150px] lg:right-[-80px] w-[347.88px] h-[425px] md:w-[500.15px] md:h-[626.36px] lg:w-[717px] lg:h-[1060px] z-10 "
      >
        <img
