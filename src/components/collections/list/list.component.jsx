...
const CollectionsList = () => {
  ...
  return (
    <div id="shop-section" className="w-full px-[5%] py-15">
      <p className="text-[#18181b] text-[20px] md:text-[30px] xl:text-[48px] text-center font-semibold mb-3">
        Shop our collections
      </p>
      <p
        className="text-[#483d3d] text-[16px] md:text-[20px] xl:text-[24px] text-center mb-3"
      ...
      {isLoading ? (
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-x-5 gap-y-10 xl:gap-y-15 mt-5">
