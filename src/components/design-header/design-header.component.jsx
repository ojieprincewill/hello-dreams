...
const DesignHeader = () => {
  return (
    <div className="flex flex-col justify-center items-center py-15 px-2 space-y-6 md:space-y-10 w-full">
      ...
      <div>
        <button className="bg-[#1342ff] lg:bg-[#010413] text-[#f7f7f7] font-semibold border border-[#1342ff] lg:border-[#010413] text-[10.91px] lg:text-[16px] px-4 py-4 rounded-3xl lg:rounded-lg hover:text-white hover:bg-[#1342ff] hover:border-[#1342ff] transition-colors duration-300 cursor-pointer">
