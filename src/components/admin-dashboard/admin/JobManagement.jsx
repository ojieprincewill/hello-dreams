  ...
  return (
    <div className="space-y-6 xl:space-y-8">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
          <h1 className="text-2xl xl:text-3xl font-bold">Job Postings</h1>
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button className="bg-green-600 hover:bg-green-700 w-full sm:w-auto">
              <Plus size={18} className="mr-2 xl:w-5 xl:h-5" /> Post New Job
            </Button>
          </DialogTrigger>
      ...
      <div className="space-y-4">
        {jobs.map((job) => (
          <Card key={job.id} className="pt-4 xl:pt-6">
            <CardContent>
              <div className="space-y-4">
                {/* Header with title and actions */}
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-base xl:text-lg text-gray-900 mb-1">
                      {job.title}
                    </h3>
                    <div className="flex items-center gap-2 text-xs xl:text-sm text-gray-600 mb-2">
                      <Building size={14} className="xl:w-4 xl:h-4" />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3 xl:gap-4">
                  <div className="flex items-center gap-2 text-xs xl:text-sm">
                    <Award
                      size={14}
                      className="text-blue-600 xl:w-4 xl:h-4 flex-shrink-0"
                    />
                    <div>
                  ...
                  <div className="flex items-center gap-2 text-xs xl:text-sm">
                    <Clock
                      size={14}
                      className="text-green-600 xl:w-4 xl:h-4 flex-shrink-0"
                    />
                    <div>
                  ...
                  <div className="flex items-center gap-2 text-xs xl:text-sm">
                    <DollarSign
                      size={14}
                      className="text-purple-600 xl:w-4 xl:h-4 flex-shrink-0"
                    />
                    <div>
                  ...
                  <div className="flex items-center gap-2 text-xs xl:text-sm">
                    <Calendar
                      size={14}
                      className="text-orange-600 xl:w-4 xl:h-4 flex-shrink-0"
                    />
                    <div>
                ...
                {/* Description preview */}
                {job.description && (
                  <div className="text-xs xl:text-sm text-gray-600 line-clamp-2">
                    {job.description}
                  </div>
                )}
                ...
                {job.company_email && (
                  <div className="flex items-center gap-2 text-xs xl:text-sm text-gray-500">
