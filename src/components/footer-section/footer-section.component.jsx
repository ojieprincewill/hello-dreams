    ...
    <div className="bg-[#010413] text-[#fff] px-5 pt-5 md:px-10 md:pt-20 pb-4">
      <div className="grid grid-cols-1 md:grid-cols-[30%_70%] md:border-t-1 border-[#ffffff10]">
        <div className="md:border-r-1 border-[#ffffff10] py-5 md:py-15">
          <Logo />
          <p className="text-[10px] md:text-[16px] text-[#ffffff91] md:font-bold pt-5 md:pt-10 md:pb-32">
        ...
        <div className="flex flex-row md:flex-col">
          <div className="flex flex-col md:flex-row justify-between items-start">
            <div className="border-l border-r md:border-0 border-[#ffffff10] pl-3 pr-[39px] md:pr-32 py-5 md:py-15">
              <h1 className="text-[12px] md:text-[14px] text-[#ffffff91] uppercase font-bold mb-4 md:mb-7">
                company
              </h1>
              <div className="text-[11px] md:text-[16px] text-[#fff] md:font-bold flex flex-col space-y-2 md:space-y-4">
                <span>Academy</span>
                <span>Our work</span>
                <span>Services</span>
                <span>Portfolio</span>
            ...
            <div className="border-r-1 border-l-1 border-[#ffffff10] flex flex-col pl-3 pr-3 md:pr-32 py-5 md:py-15">
          ...
          <div className="w-full h-max grid grid-cols-2 text-[#fff] text-[11px] md:text-[20px] font-bold border-t border-b border-[#ffffff10]">
