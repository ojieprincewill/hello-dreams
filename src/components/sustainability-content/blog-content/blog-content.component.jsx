  ...
  return (
    <>
      ...
      <div className="w-full px-[5%] py-10">
        ...
        <p className="text-[#0d111c] text-[14px] md:text-[16px] ">
        ...
        <p className="text-[#000000] text-[16px] md:text-[24px] mb-7 pt-7">
          🌱 {title}
        </p>
        <p className="text-[#000000] text-[16px] md:text-[20px] mb-7">
        ...
        <ol className="list-decimal pl-5 md:pl-10 space-y-3">
          <li className="text-[#000000] text-[16px] md:text-[20px]">
        ...
        <p className="text-[#000000] text-[16px] md:text-[20px] my-7">
          Why It Matters
          <br />
