      ...
      >
        ...
        <div className="relative bg-[#efece9] rounded-2xl overflow-hidden">
          ...
          <motion.img
            ...
            alt="outline-svg-2"
            className="justify-self-center md:absolute md:bottom-[20px] md:right-[20px] w-[175.14px] h-full md:w-[300.23px] md:h-auto xl:hidden object-contain md:object-cover"
          />
        </div>
      </motion.div>
      <motion.img
        ...
        src="https://res.cloudinary.com/dganx8kmn/image/upload/f_webp,q_auto/v1750071727/Graphics%20page/sitting-1_rgsth5.png"
        alt="outline-svg-2"
        className="hidden xl:block absolute bottom-[-10px] right-[80px] xl:w-[747.31px] xl:h-[890px] object-cover"
      />
    </div>
  );
};
