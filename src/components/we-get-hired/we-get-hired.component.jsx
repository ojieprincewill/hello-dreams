...
const WeGetHired = () => {
  return (
    <div className="w-full px-[5%] xl:px-[10%] py-10">
      ...
      <p
        className="text-[12px] xl:text-[17.44px] text-[#667085] text-center xl:font-bold"
        style={{ fontFamily: "'DM Sans', sans-serif" }}
      >
        The below
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 xl:gap-5 mt-10">
        ...
        <motion.div
          ...
          className="md:col-span-2 xl:col-span-1 h-[380px] shadow-lg shadow-[#0000003c] rounded-xl overflow-hidden"
        >
            ...
            <div className="grid grid-cols-2 gap-1">
              <div className="bg-[#000000]/18 rounded-xl overflow-hidden flex justify-center items-center">
                <img
                  ...
                  alt="brand image 2"
                  className="w-full h-full md:w-[40%] md:h-auto xl:w-full xl:h-full object-cover"
                />
              </div>
              <div className="bg-[#000000]/18 rounded-xl overflow-hidden flex justify-center items-center">
                <img
