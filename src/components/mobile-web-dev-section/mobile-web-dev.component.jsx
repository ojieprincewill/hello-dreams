    ...
    <div className="space-y-5">
      {MobileWebData.map((data) => (
        <div key={data.id} className="px-[5%] py-10">
          <p className="text-[#101828] text-[48px] text-center font-bold mb-5 ">
            {data.header}
          </p>
          <p
            className="text-[#667085] text-[17.44px] text-center mb-5 "
          ...
          <div className="grid grid-cols-4 gap-5 mt-15">
            {data.options.map((option) => (
              <div key={option.id} className="p-1">
                <p
                  className="text-[#336aea]/80 text-[12px] font-semibold uppercase mb-3"
                  style={{ fontFamily: "'Inter', sans-serif" }}
                >
                  {option.title}
                </p>
                <p
                  className="text-[#424242] text-[17px] mb-5 leading-[1.5]"
                  style={{ fontFamily: "'Inter', sans-serif" }}
                >
                  {option.text}
                </p>
