      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            className="w-full bg-[#1342ff] text-[#fff] text-[16px] lg:text-[24px] font-semibold py-3 mt-3 rounded-lg hover:bg-blue-700 transition-colors duration-300 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
          >
