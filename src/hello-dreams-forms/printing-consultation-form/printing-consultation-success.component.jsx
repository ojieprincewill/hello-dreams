...
const PrintingConsultationSuccess = () => {
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col justify-center items-center py-20 px-[5%]">
      ...
      <p
        ...
        style={{ fontFamily: "'DM Sans', sans-serif" }}
      >
        Thank you for considering our printing services! We have received your
        request and will contact you shortly to confirm your request. In the
...
export default PrintingConsultationSuccess;
